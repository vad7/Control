...
#define f2LogTempError			8			// Логировать ошибки датчиков температуры
#define f2LogExtendedInfo		9			// Логировать расширенную инфу
...
private:
	...
	void    StopWait(bool stop);          // Функция Останова/Ожидания ТН  - возвращает код ошибки
	...
	bool    configHP();                   // Концигурация 4-х, 3-х ходового крана и включение насосов, выход - разрешение запуска компрессора
	bool    Switch_R4WAY(bool fCool);     // Переключение реверсивного 4-х ходового клапана (true - охлаждение, false - нагрев), возврат true если переключили

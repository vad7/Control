...
#define VERSION			"1.165"				// Версия прошивки
...
#define HeatFloorDeltaTemp			 	300	// Добавка к целевой температуре для раздельного управления реле теплого пола, полученная температура будет целевой для ТП

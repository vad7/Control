...
struct type_setting_heat {
	...
	int16_t TempOutLim;				// Tемпература подачи (минимальная для охлаждения или максимальная для нагрева)
	int16_t TempInLim;				// Tемпература обратки для включения (максимальная для охлаждения или минимальная для нагрева)
	uint16_t WorkPause;				// Минимальное время простоя, секунды

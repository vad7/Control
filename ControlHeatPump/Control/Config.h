...
//	#define WR_NOPWR_READ_MAP_INSTEAD_OF_MPPT			// При отсключении питания читать напряжение с MAP, иначе с MPPT
	...
	//-----------------------------------------------------------------------------------------------------------------------------
	// Удаленный датчик для информирования (счетчик импульсов) - Код ошибки BMS
	// Принцип: код предупреждения считается как количество импульсов шириной MIN..MAX, после каждого импульса должна быть пауза MIN..MAX
	...
	static const char *RWARN_WARNING_TEXT[] = { "Ok", "Не отвечает", "Ошибка", "Пере-Разряд ячейки", "Пере-Заряд ячейки", "Разбег ячеек" };
	#endif
	//-----------------------------------------------------------------------------------------------------------------------------
	// Графики в памяти
	Charts_Mod_setup ChartsModSetup[] = {

...
//  	#define TEST_BOARD 				// Тестовая плата!
  ...
  //	#define WR_CurrentSensor_4_20mA	IWR								// Использовать аналоговый датчик тока с выходом 4-20mA, номер ADC датчика
  	...
  	const uint8_t WF_SunByMonth[12] = 	{ 60,  45,  10,   0,   0,   0,   0,   0,  15,  30,  40,  60 };	// + к облачности, %
...
//	#define WR_NOPWR_READ_MAP_INSTEAD_OF_MPPT			// При отсключении питания читать напряжение с MAP, иначе с MPPT
	...
	#define WEB0_OTHER_JOB_PERIOD    	10000UL   		// Периодичность других функций внутри задачи WEB0, мс
	#define WEB1_OTHER_JOB_PERIOD    	15000UL   		// Периодичность других функций внутри задачи WEB1, мс
	...
	//                                   янв, фев, мар, апр, май, июн, июл, авг, сен, окт, ноя, дек
	const uint8_t WF_SunByMonth[12] = 	{ 60,  30,  3,   0,   0,   0,   0,   0,  10,  30,  40,  60 };	// + к облачности, %

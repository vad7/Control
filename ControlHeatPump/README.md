...
Версия 1.207<br>
1. Котел электрический или газовый. Управление через адаптер EctoControl Opentherm (модбас) или реле или Модбас реле. Возможность настроить раздельные цели для котла и ТН<br>

...
Несколько оттестированный релиз здесь: https://github.com/vad7/ControlHeatPump<br>
<br>
...
Версия 1.216<br>
1. Предварительный нагрев трассы котла по времени и по температуре, отложенное включение теплого пола по температуре
2. Доработка Modbus
3. рефакторинг кода
Версия 1.207<br>
1. Котел электрический или газовый. Управление через адаптер EctoControl RS485 (Modbus) или реле или Модбас реле. Возможность настроить раздельные цели для котла и ТН<br>
2. Динамические картинки на схеме.
3. Рефакторинг кода, оптимизация веба, отказ от семафоров RTOS, PID для охлаждения
4. Возможность греть бойлер только тэном
5. Мониторинг и информирования о ошибках и состояния нескольких BMS АКБ (входной программный UART на скорости 333 бод)
Версия 1.200<br>
